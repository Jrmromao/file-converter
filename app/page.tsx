...
//       className="absolute top-4 right-4 p-2 rounded-full bg-white/80 dark:bg-neutral-800/80 shadow-md transition-colors duration-200"
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 dark:from-neutral-950 dark:to-neutral-800 p-4 font-sans antialiased">
//       <DarkModeToggle />
//       {/* --- Logo & Brand --- */}
//       <div className="w-full flex items-center pl-2 mt-4 mb-8">
//         <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg mr-2">
//           IC
//         </div>
//         <span className="text-xl font-extrabold text-slate-800 dark:text-white tracking-tight">Image Converter Pro</span>
//       </div>

//       {/* --- Top Banner Ad Placeholder --- */}
//       <div className="w-full flex justify-center mb-8">
//         <div className="bg-gray-200 dark:bg-neutral-800 rounded-lg w-full max-w-4xl h-16 flex items-center justify-center text-gray-500 dark:text-neutral-300 text-sm font-semibold border border-gray-300 dark:border-neutral-700">
...
//           <h1 className="text-5xl font-extrabold text-slate-900 dark:text-white mb-4 leading-tight">Your Ultimate Image Converter</h1>
//           <p className="text-xl text-slate-700 dark:text-neutral-300 max-w-3xl mx-auto">
...
//             <Card className="shadow-2xl border-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg rounded-2xl p-6">
//               <CardHeader className="pb-8">
//                 <CardTitle className="text-3xl font-bold text-center text-slate-800 dark:text-white">Convert Your Images</CardTitle>
//               </CardHeader>
//               <CardContent className="space-y-8">
//                 {/* File Upload Area */}
//                 <div
//                   className={`relative border-3 border-dashed rounded-2xl p-10 text-center transition-all duration-300 ease-in-out cursor-pointer group
//                     ${isDragOver
//                       ? "border-blue-500 bg-blue-50 dark:bg-blue-950/20"
//                       : selectedFile
//                         ? "border-green-500 bg-green-50 dark:bg-green-950/20"
//                         : "border-slate-300 dark:border-neutral-700 hover:border-blue-400 hover:bg-slate-50 dark:hover:bg-neutral-800/50"
//                     }
//                   `}
//                   onDrop={handleDrop}
...
//                       {previewUrl && (
//                         <div className="relative max-h-64 flex justify-center items-center rounded-xl overflow-hidden bg-slate-100 dark:bg-neutral-700 p-2">
//                           <img
//                             src={previewUrl}
//                             alt="Preview"
...
//                             variant="ghost"
//                             size="icon"
//                             className="absolute top-3 right-3 bg-white/70 dark:bg-neutral-800/70 hover:bg-white dark:hover:bg-neutral-700 text-slate-700 dark:text-white rounded-full shadow-md transition-transform duration-200 hover:scale-110"
//                             onClick={(e) => {
//                               e.stopPropagation()
//                               setShowPreview(true)
//                             }}
...
//                       )}
//                       <div>
//                         <p className="font-semibold text-lg text-slate-800 dark:text-white truncate">{selectedFile.name}</p>
//                         <p className="text-sm text-slate-500 dark:text-neutral-400">{(selectedFile.size / 1024 / 1024).toFixed(2)} MB</p>
//                         {detectedFormat && (
//                           <Badge variant="secondary" className="mt-3 text-base px-3 py-1 bg-blue-500 text-white dark:bg-blue-700 dark:text-blue-100 shadow-sm">
...
//                         )}
//                       </div>
//                       <Badge variant="secondary" className="bg-green-500 text-white dark:bg-green-700 dark:text-green-100 text-base px-3 py-1 shadow-sm">
//                         Image Selected
//                       </Badge>
//                     </div>
//                   ) : (
//                     <div className="space-y-4">
//                       <Upload className="w-16 h-16 text-blue-400 dark:text-blue-500 mx-auto transition-transform duration-300 group-hover:scale-110" />
//                       <div>
//                         <p className="text-xl font-semibold text-slate-700 dark:text-white">Drop your image here or click to browse</p>
...
//                   <DialogContent className="max-w-4xl dark:bg-neutral-900 dark:text-white p-6 rounded-xl">
//                     <DialogHeader>
//                       <div className="flex items-center justify-between w-full">
//                         <DialogTitle className="font-bold text-xl">Image Preview</DialogTitle>
//                         <Button
//                           variant="outline"
//                           size="sm"
...
//                         </Button>
//                       </div>
//                       <DialogDescription className="dark:text-neutral-300 text-sm mt-1">
...
//                   <label className="text-lg font-medium text-slate-700 dark:text-neutral-200">Convert to</label>
//                   <Select value={toFormat} onValueChange={setToFormat}>
//                     <SelectTrigger className="h-14 text-base bg-white border-slate-200 dark:bg-neutral-800 dark:border-neutral-700 dark:text-white rounded-lg shadow-sm">
//                       <SelectValue placeholder="Select target format" />
//                     </SelectTrigger>
//                     <SelectContent className="dark:bg-neutral-800 dark:text-white border-neutral-700">
//                       {fileFormats
//                         .filter((format: FileFormat) => format.value !== detectedFormat)
//                         .map((format: FileFormat) => (
//                           <SelectItem key={format.value} value={format.value} className="dark:text-white hover:bg-neutral-700">
...
//                 {/* Advanced Options */}
//                 {showAdvanced && (
//                   <div className="space-y-7 p-6 bg-slate-50 dark:bg-neutral-800 rounded-xl shadow-inner border border-slate-100 dark:border-neutral-700">
//                     <div className="grid md:grid-cols-2 gap-6">
//                       {/* Quality Slider */}
//                       <div className="space-y-2">
//                         <Label className="text-slate-700 dark:text-neutral-200 text-sm">Quality: {imageOptions.quality}%</Label>
//                         <Slider
...
//                           max={100}
//                           step={1}
//                           className="[&>span:first-child]:bg-blue-500 dark:[&>span:first-child]:bg-blue-600 [&>span:last-child>span]:bg-white dark:[&>span:last-child>span]:bg-neutral-300 [&>span:last-child>span]:border-blue-500 dark:[&>span:last-child>span]:border-blue-600"
//                         />
//                       </div>

//                       {/* Rotation Slider */}
//                       <div className="space-y-2">
//                         <Label className="text-slate-700 dark:text-neutral-200 text-sm">Rotation: {imageOptions.rotate}°</Label>
//                         <Slider
...
//                       {/* Width Input */}
//                       <div className="space-y-2">
//                         <Label className="text-slate-700 dark:text-neutral-200 text-sm">Width (px)</Label>
//                         <input
//                           type="number"
//                           className="w-full p-3 border border-slate-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-700 text-slate-800 dark:text-neutral-100 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all"
...
//                       {/* Height Input */}
//                       <div className="space-y-2">
//                         <Label className="text-slate-700 dark:text-neutral-200 text-sm">Height (px)</Label>
//                         <input
//                           type="number"
//                           className="w-full p-3 border border-slate-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-700 text-slate-800 dark:text-neutral-100 focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all"
...
//                         <div className="space-y-2">
//                           <Label className="text-slate-700 dark:text-neutral-200 text-sm">Brightness: {imageOptions.brightness}%</Label>
//                           <Slider
...
//                             max={100}
//                             step={1}
//                             className="[&>span:first-child]:bg-purple-500 dark:[&>span:first-child]:bg-purple-600 [&>span:last-child>span]:bg-white dark:[&>span:last-child>span]:bg-neutral-300 [&>span:last-child>span]:border-purple-500 dark:[&>span:last-child>span]:border-purple-600"
//                           />
//                         </div>
//                         <div className="space-y-2">
//                           <Label className="text-slate-700 dark:text-neutral-200 text-sm">Contrast: {imageOptions.contrast}%</Label>
//                           <Slider
...
//                         </div>
//                         <div className="space-y-2">
//                           <Label className="text-slate-700 dark:text-neutral-200 text-sm">Saturation: {imageOptions.saturation}%</Label>
//                           <Slider
...
//                             className={`w-full text-sm py-2 px-3 ${imageOptions.filter === key ? 'bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-800 text-white' : 'border-slate-300 text-slate-700 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-700'}`}
//                           >
...
//                             className={`w-full ${imageOptions.grayscale ? 'bg-rose-600 hover:bg-rose-700 dark:bg-rose-700 dark:hover:bg-rose-800 text-white' : 'border-slate-300 text-slate-700 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-700'}`}
//                           >
...
//                             className={`w-full ${imageOptions.optimize ? 'bg-amber-600 hover:bg-amber-700 dark:bg-amber-700 dark:hover:bg-amber-800 text-white' : 'border-slate-300 text-slate-700 dark:border-neutral-600 dark:text-neutral-200 dark:hover:bg-neutral-700'}`}
//                           >
...
//                         </div>
//                         <div className="space-y-2">
//                           <Label className="text-slate-700 dark:text-neutral-200 text-sm">Blur: {imageOptions.blur.toFixed(1)}</Label>
//                           <Slider
...
//                         </div>
//                         <div className="space-y-2">
//                           <Label className="text-slate-700 dark:text-neutral-200 text-sm">Sharpen: {imageOptions.sharpen.toFixed(1)}</Label>
//                           <Slider
...
//                     <div className="space-y-4">
//                       <h3 className="font-semibold text-slate-700 dark:text-neutral-100 text-lg">Format Specific</h3>
//                       <div className="grid md:grid-cols-3 gap-6">
...
//                           />
//                           <Label htmlFor="preserve-metadata" className="text-slate-700 dark:text-neutral-200">Preserve Metadata</Label>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                           <Switch
//                             id="progressive"
...
//                             className="data-[state=checked]:bg-green-500 dark:data-[state=checked]:bg-green-600"
//                           />
//                           <Label htmlFor="progressive" className="text-slate-700 dark:text-neutral-200">Progressive Loading</Label>
//                         </div>
//                         <div className="flex items-center space-x-2">
//                           <Switch
//                             id="lossless"
...
//                             className="data-[state=checked]:bg-green-500 dark:data-[state=checked]:bg-green-600"
//                           />
//                           <Label htmlFor="lossless" className="text-slate-700 dark:text-neutral-200">Lossless Compression</Label>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//                 {/* Conversion Result */}
//                 {convertedFile && (
//                   <Card className="bg-gradient-to-r from-emerald-50 to-green-100 border-green-300 dark:from-emerald-900/60 dark:to-green-900/60 dark:border-green-700 rounded-xl shadow-lg">
//                     <CardContent className="p-6 flex items-center justify-between flex-wrap gap-4">
//                       <div className="flex items-center gap-4">
//                         <div className="w-12 h-12 bg-green-200 rounded-full flex items-center justify-center dark:bg-green-800/80">
//                           <Download className="w-6 h-6 text-green-700 dark:text-green-300" />
//                         </div>
//                         <div>
//                           <p className="font-bold text-lg text-green-800 dark:text-green-200">Conversion Complete!</p>
//                           <p className="text-sm text-green-600 dark:text-green-300">{convertedFile}</p>
//                         </div>
//                       </div>
//                       <Button onClick={handleDownload} className="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white font-semibold py-2 px-5 rounded-md">
//                         <Download className="w-4 h-4 mr-2" />
//                         Download Now
//                       </Button>
//                     </CardContent>
...
//             {/* Features Card */}
//             <Card className="shadow-xl border-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg rounded-2xl p-6">
//               <CardHeader className="pb-6">
//                 <CardTitle className="text-2xl font-bold text-slate-800 dark:text-white">Key Features</CardTitle>
//               </CardHeader>
...
//                   </div>
//                   <div>
//                     <p className="font-semibold text-slate-700 dark:text-white text-lg">Blazing Fast Conversion</p>
//                     <p className="text-sm text-slate-500 dark:text-neutral-300">Convert images in mere seconds with our optimized engine.</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start gap-4">
//                   <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center dark:bg-green-900/50">
//                     <Shield className="w-5 h-5 text-green-600 dark:text-green-300" />
//                   </div>
//                   <div>
//                     <p className="font-semibold text-slate-700 dark:text-white text-lg">Ultimate Data Privacy</p>
//                     <p className="text-sm text-slate-500 dark:text-neutral-300">Your files are processed temporarily and never stored. Complete confidentiality.</p>
//                   </div>
//                 </div>
//                 <div className="flex items-start gap-4">
...
//                   </div>
//                   <div>
//                     <p className="font-semibold text-slate-700 dark:text-white text-lg">Advanced Image Toolkit</p>
//                     <p className="text-sm text-slate-500 dark:text-neutral-300">Access powerful features like resizing, rotation, quality control, and artistic filters.</p>
//                   </div>
//                 </div>
//               </CardContent>
//             </Card>
//             {/* Sidebar Ad */}
//             <div className="w-full flex justify-center mb-8">
//               <div className="bg-gray-200 dark:bg-neutral-800 rounded-lg w-full max-w-2xl h-24 flex items-center justify-center text-gray-500 dark:text-neutral-300 text-sm font-semibold border border-gray-300 dark:border-neutral-700">
...
//             <Card className="shadow-xl border-0 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-lg rounded-2xl p-6">
//               <CardHeader className="pb-6">
//                 <CardTitle className="text-2xl font-bold text-slate-800 dark:text-white">Supported Formats</CardTitle>
//               </CardHeader>
//               <CardContent>
...
//                       key={format.value}
//                       variant="secondary"
//                       className="justify-center py-3 text-sm font-semibold bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-neutral-800 dark:text-white dark:hover:bg-neutral-700 transition-colors duration-200"
//                     >
//                       <span className="text-lg mr-1">{format.icon}</span>
...
//         {/* Footer */}
//         <footer className="text-center mt-16 pt-8 pb-8 text-slate-600 dark:text-neutral-400 border-t border-slate-200 dark:border-neutral-800">
...
//             <a href="/contact" className="hover:underline text-blue-600 dark:text-blue-400">Contact Us</a>
//             <a href="/about" className="hover:underline text-blue-600 dark:text-blue-400">About</a>
//             <a href="/faq" className="hover:underline text-blue-600 dark:text-blue-400">FAQ</a>
//           </div>
//           <p className="text-sm">
//             © {new Date().getFullYear()} Image Converter Pro. Convert images with confidence.
//           </p>
//         </footer>
//       </div>
//     </div>
...
export default function FileConverter() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900 p-4 font-sans antialiased">
      ...
      {/* --- Logo & Brand --- */}
      <div className="w-full flex items-center pl-2 mt-4 mb-8">
        <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg mr-2">
          IC
        </div>
        <span className="text-xl font-extrabold text-slate-800 dark:text-neutral-100 tracking-tight">Image Converter Pro</span>
      </div>

      {/* --- Top Leaderboard Ad Slot (Responsive, Recommended size: 728x90) --- */}
      <div className="w-full flex justify-center mb-8">
        <div className="bg-neutral-100 dark:bg-neutral-800 rounded-xl w-full max-w-4xl h-16 flex items-center justify-center text-neutral-500 dark:text-neutral-500 text-sm font-medium border border-neutral-200 dark:border-neutral-700">
          {/* Replace this with your actual Google AdSense responsive ad code */}
          <p>AD UNIT: Top Leaderboard (Responsive)</p>
            ...
            <Card className="shadow-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 rounded-2xl p-6">
              ...
              <CardContent className="space-y-8">
                ...
                <div className="w-full flex justify-center mt-8">
                    <div className="bg-neutral-100 dark:bg-neutral-800 rounded-xl w-full max-w-sm h-40 flex items-center justify-center text-neutral-500 dark:text-neutral-500 text-sm font-medium border border-neutral-200 dark:border-neutral-700">
                        {/* Replace this with your actual Google AdSense responsive ad code */}
                        <p>AD UNIT: In-Content (Responsive)</p>
                    </div>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="w-full flex justify-center">
              <div className="bg-neutral-100 dark:bg-neutral-800 rounded-xl w-full max-w-xs h-60 flex items-center justify-center text-neutral-500 dark:text-neutral-500 text-sm font-medium border border-neutral-200 dark:border-neutral-700">
                {/* Replace this with your actual Google AdSense responsive ad code */}
                <p>AD UNIT: Sidebar (Responsive)</p>
              </div>
            </div>

            {/* Supported Formats */}
            <Card className="shadow-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 rounded-2xl p-6">
              <CardHeader className="pb-6 flex items-center"> {/* Added flex items-center */}
                <Palette className="w-7 h-7 text-blue-600 dark:text-blue-400 mr-3" /> {/* New icon for the section title */}
                <CardTitle className="text-2xl font-bold text-slate-800 dark:text-neutral-100">Supported Formats</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {fileFormats.map((format) => (
                    <Badge
                      key={format.value}
                      variant="secondary"
                      className="justify-center py-3 text-sm font-semibold bg-neutral-100 text-slate-700 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 transition-colors duration-200 border border-neutral-200 dark:border-neutral-700"
                    >
                       {/* Removed individual format.icon here */}
                      <span>{format.label}</span>
                    </Badge>
                  ))}
                </div>
