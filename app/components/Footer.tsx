...
export default function Footer() {
  return (
    <footer className="w-full bg-white/90 dark:bg-neutral-900/90 border-t border-gray-200 dark:border-neutral-800 mt-12 py-8 px-0">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 px-4 md:pl-64">
